...
struct MaintenanceProfilePage1View: View {
    ...
    private func fieldRow(
        ...
        error: String? = nil, keyboard: UIKeyboardType = .default,
...
#Preview {
    MaintenanceProfilePage1View(viewModel: MaintenanceProfileViewModel())
}
